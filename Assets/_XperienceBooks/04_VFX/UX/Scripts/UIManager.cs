...
public class UIManager : MonoBehaviour
{
    ...
    [SerializeField]
    ImageTrackingController m_ImageManager;
    public ImageTrackingController imageManager
    {
        get => m_ImageManager;
    ...
    //public bool ScreenshortEnable = false;
    ...
    void OnEnable()
    {
        ...
        PlacementController.onPlacedObject += () => m_PlacedObject = true;
    ...
    bool ImageFound()
    {
        ...
        return m_ImageManager.m_ImageManager?.trackables.count > 0;
    }
